...
## 版本历史
- v0.1.0 2022年4月9日 新增GET和POST请求
- v0.1.1 2022年4月11日 POST的map默认当表单数据
- v0.1.2 2022年4月11日 添加忽略URL解析错误的请求方法
- v0.1.3 2022年4月12日 支持POST纯文本数据
- v0.1.4 2022年4月12日 代码重构
- v0.1.5 2022年4月13日 支持任意类型HTTP请求
- v0.1.6 2022年4月13日 支持设置代理
- v0.1.7 2022年4月13日 支持发送JSON数据
- v0.1.8 2022年4月16日 解决部分URL无法正常请求的BUG
- v0.1.9 2022年4月18日 BUG修复：header请求头重复
- v0.2.0 2022年4月18日 新增：获取请求和响应详情
- v0.2.1 2022年4月20日 新增：获取响应状态码
- v0.2.2 2022年4月20日 新增：下载文件
- v0.2.3 2022年4月21日 新增：文件上传
- v0.2.4 2022年4月22日 新增：支持上传FS文件系统文件
- v0.2.5 2022年4月28日 新增：检查重定向和请求消耗时间
